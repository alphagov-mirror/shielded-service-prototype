    ...
    return {
            ...
            timeline: [
        ...
        },
                {
                    ...
                    eventDetails: [
                        {
                            field: 'Address',
                            value: '72 Guild Street, Forest Hill'
                        },
                        {
                            field: 'Postcode',
                            value: 'SE236FH'
        ...
        },
                {
                    ...
                    eventDetails: [
                        {
                            field: 'SPL Source',
                            value: 'GP WEEKLY UPDATE'
                        },
                        {
                            field: 'Reason',
                            value: 'No further need to shield'
                        }
          ]
        }
      ]
        ...
        '0111053029': {
            ...
            summary: {
                ...
                name: 'Andrew Moseley',
                dob: '17 June 1946',
                latestAddress: ['105 Ravenhurst Street', 'Bordesley', 'Birmingham', 'B12 0HB'],
                latestAddressLA: 'Birmingham City Council',
                nhsAddress: ['150 HIGH ST, TEWKESBURY', 'GL20 5JU'],
            ...
            timeline: [
        ...
        },
                {
                    ...
                    badges: [{
                            ...
                            text: 'Shopping support: yes',
                            value: true
          },
                        {
                            text: 'Priority slots: yes',
                            value: true
                    }],
                    eventDetails: [
                        {
                            field: 'Address',
                            value: '105 Ravenhurst Street, Bordesley, Birmingham'
                        },
                        {
                            field: 'Postcode',
                            value: 'B12 0HB'
        ...
        '2082035560': {
            ...
            summary: {
                ...
                phone: '0114 272 9003',
                email: 'shillpa.chaghanti@example.com',
                deceased: true,
                dod: '14th Sept 2020'
            },
            spl: {
            ...
            timeline: [
        ...
        },
                {
                    ...
                    eventDetails: [
                        {
                            field: 'Address',
                            value: '1 Sheaf Street, Sheffield'
                        },
                        {
                            field: 'Postcode',
                            value: 'S1 2BP'
